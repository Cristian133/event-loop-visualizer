...
console.log('Fin');`,
        steps: [
            ...
            { callStack: [], microtaskQueue: [], macrotaskQueue: [], webApi: [], console: ['Inicio'], activeLine: 0, explanation: 'Se ejecuta console.log, sale del Call Stack y pisa la Consola.' },
            ...
            { callStack: ['saludar()', 'console.log("Hola")'], microtaskQueue: [], macrotaskQueue: [], webApi: [], console: ['Inicio'], activeLine: 2, explanation: 'Dentro de saludar(), el console.log entra en la cima del Call Stack (LIFO).' },
            { callStack: ['saludar()'], microtaskQueue: [], macrotaskQueue: [], webApi: [], console: ['Inicio', 'Hola'], activeLine: 2, explanation: 'Se ejecuta console.log, sale del Call Stack y escribe en Consola.' },
            ...
            { callStack: [], microtaskQueue: [], macrotaskQueue: [], webApi: [], console: ['Inicio', 'Hola', 'Fin'], activeLine: 5, explanation: 'Se ejecuta la instrucción y el programa termina limpiamente.' },
        ]
    },
    {
        id: 'async-macro',
...
console.log('3');`,
        steps: [
            ...
            { callStack: [], microtaskQueue: [], macrotaskQueue: [], webApi: [], console: ['1'], activeLine: 0, explanation: 'Escribe en consola.' },
            ...
            { callStack: ['callback setTimeout', 'console.log("2")'], microtaskQueue: [], macrotaskQueue: [], webApi: [], console: ['1', '3'], activeLine: 2, explanation: 'El callback ejecuta su interior, enviando console.log("2") a la cima de la pila.' },
